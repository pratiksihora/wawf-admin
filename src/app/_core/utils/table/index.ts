...
} from "src/app/constants/models/controls/table/table-config";
import { ColumnConfig, TableBaseConfig } from "src/app/constants/models/controls/table/table-config/config";

// Constants
import {
  BOOLEAN_SELECT_FILTERS, DATE_FILTERS, MULTI_SELECT_FILTERS,
  NUMBER_FILTERS, SINGLE_SELECT_FILTERS, STRING_FILTERS
} from "src/app/constants/static-constants/controls/table/table-filter";
