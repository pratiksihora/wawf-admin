...
export const FormFields: { [key: string]: Field } = {
    time_to_extend: SelectUtil.configureSelect({ key: 'time_to_extend', label: 'Anti-Fraud Rule', smallControl: true, layout: LayoutType.VERTICAL, }, { required: true }, { options: [{ value: '1 Month', text: '1 Month' }, { value: '2 Month', text: '2 Month' }] }, others),
    number_of_device: InputUtil.configureNumber({
        key: 'number_of_device', label: 'Single code length', defaultValue: 2, disabled: true, smallControl: true,
