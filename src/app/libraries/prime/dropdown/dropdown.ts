...
import {OverlayService, PrimeNGConfig, SelectItem, TranslationKeys} from '../api';
import {SharedModule,PrimeTemplate, FilterService} from '../api';
...
export class Dropdown implements OnInit,AfterViewInit,AfterContentInit,AfterViewChecked,OnDestroy,ControlValueAccessor {
    ...
    @Input() dropdownIcon: string = 'bi bi-chevron-down';
