...
import {Message,PrimeTemplate,MessageService} from '../api';
            ...
            <ng-container *ngIf="!contentTemplate; else staticMessage">
                <div *ngFor="let msg of value; let i=index" [ngClass]="'p-message p-message-' + msg.severity" role="alert"
                    ...
                    <div class="p-message-wrapper">
                       <span [class]="'p-message-icon bi pi' + (msg.icon ? ' ' + msg.icon : '')" [ngClass]="{'pi-info-circle': msg.severity === 'info',
                            'bi-check': msg.severity === 'success',
