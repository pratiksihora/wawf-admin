...
import { PrimeTemplate, SharedModule, FilterService } from '../api';
    ...
    template: `
        <div class="p-checkbox p-component" [ngClass]="{'p-checkbox-focused':focused}" (click)="onClick($event)">
            ...
            <div #box [ngClass]="{'p-checkbox-box':true,
                ...
                <span class="p-checkbox-icon bi" [ngClass]="{'bi-check':checked, 'bi-minus': rowNode.node.partialSelected}"></span>
            </div>
        </div>
    `,
    encapsulation: ViewEncapsulation.None,
