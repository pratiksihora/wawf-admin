...
export class InputNumber implements OnInit, ControlValueAccessor {
    ...
    getCurrencyExpression() {
        if (this.currency) {
            const formatter = new Intl.NumberFormat(this.locale, {
                style: 'currency', currency: this.currency, currencySign: this.currencyDisplay,
    ...
    getPrefixExpression() {
        if (this.prefix) {
            ...
            const formatter = new Intl.NumberFormat(this.locale, { style: this.mode, currency: this.currency, currencySign: this.currencyDisplay });
    ...
    getSuffixExpression() {
        if (this.suffix) {
            ...
            const formatter = new Intl.NumberFormat(this.locale, {
                style: this.mode, currency: this.currency, currencySign: this.currencyDisplay,
                minimumFractionDigits: 0, maximumFractionDigits: 0
            });
