  ...
  */
  ...
  static configureAction(config: TableBaseConfig): ActionOption {
    ...
    return {
      ...
      message: config.message != undefined ? config.message : false,
      refund: config.refund != undefined ? config.refund : false,
      ...
      extendConfig: ButtonUtil.configure({ type: 'cloneIcon', size: 'sm', space: 'me-1', ...config.extendConfig, permission: config.viewPermission || config.managePermission }),
      deviseConfig: ButtonUtil.configure({ type: 'cloneIcon', size: 'sm', space: 'me-1', ...config.deviseConfig, permission: config.viewPermission || config.managePermission }),
      creditConfig: ButtonUtil.configure({ type: 'cloneIcon', size: 'sm', space: 'me-1', ...config.creditConfig, permission: config.viewPermission || config.managePermission }),
      messageConfig: ButtonUtil.configure({ type: 'cloneIcon', size: 'sm', space: 'me-1', ...config.messageConfig, permission: config.viewPermission || config.managePermission }),
      refundConfig: ButtonUtil.configure({ type: 'cloneIcon', size: 'sm', space: 'me-1', ...config.refundConfig, permission: config.viewPermission || config.managePermission }),
