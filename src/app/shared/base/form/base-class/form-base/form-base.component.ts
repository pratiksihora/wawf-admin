...
export abstract class FormBaseComponent implements OnInit, OnDestroy {
  ...
  constructor(public cdr?: ChangeDetectorRef, public translate?: TranslateService) {
  }
  ...
  */
  ...
  _intialShowExpression() {
    ...
    if (this.field.permission?.showFunc) {
      let hidden = this.field.permission?.showFunc({ form: this.form, parentForm: this.parentForm, field: this.field });
  ...
  _intialEnableExpression() {
    ...
    if (this.field.permission?.enableFunc) {
      let enabled = this.field.permission?.enableFunc({ form: this.form, parentForm: this.parentForm, field: this.field });
