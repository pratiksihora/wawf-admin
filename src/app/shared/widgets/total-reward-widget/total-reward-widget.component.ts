...
@Component({
  selector: 'app-total-reward-widget',
  templateUrl: './total-reward-widget.component.html',
  styleUrls: ['./total-reward-widget.component.scss']
})
export class TotalRewardWidgetComponent implements OnInit {
  chartOptions: any = {};
  ...
  initChart(chartSize: number = 70, chartLine: number = 11, chartRotate: number = 145) {
    ...
    drawCircle(getCSSVariableValue('--kt-primary'), options.lineWidth, this.data?.total_redeem_count / (this.data?.total_reward_count + this.data?.total_redeem_count));
